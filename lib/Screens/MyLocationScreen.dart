...
import 'package:location/Screens/DetailedLocation.dart';
import '../Components/Widgets/LocationListViewListTile.dart';
import '../Controllers/MyLocationController.dart';
...
class MyLocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () {
          if (myLocationController.locationList.isEmpty) {
            return const Center(
              child: Text(
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                      itemCount: myLocationController.locationList.length,
                      itemBuilder: (context, index) {
                        final data = myLocationController.locationList[index];
